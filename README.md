...
El apartado **4**  habla del equipo que hay detrás del proyecto y para finalizar en la parte **5** están los datos de contacto. 
...
1. Editores visuales de texto WYSIWYG (What You See Is What You Get)
	...
	- [Lenguaje Tool](https://languagetool.org/): Es un revisor ortografico integrado al navegador, como gramarly pero en español. No se hace problema si escribes en diferentes idiomas al mismo tiempo. Lo sugiero porque Notion tiene problemas en este aspecto. Solo funciona en Google Chome, cuando la ventana del cuaderno de apuntes no esta en pantalla completa. La imagen inferior muestra cuando la integracion es corecta.
...
3. Sigue el orden propuesto por Platzi.
...
Enumera, usa puntos, evita poner bloques enormes de texto. Mientras mas estructuado mejor, doble para que no lo olvides.
	- Ejemplo:
	
		| Incorecto | Corecto |  
		|------------|-------------|  
		| <img  src="https://i.ibb.co/2vRP4JW/errores1.jpg"   width="600" align="top"  />|<img  src="https://i.ibb.co/vPC8PxN/errores2.jpg"  alt="Kitten"    width="600" align="top" /> 
